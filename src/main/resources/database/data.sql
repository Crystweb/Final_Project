...
INSERT INTO `shift_comment` (employee_id, c_message, c_date) VALUES (1, 'Постояльцы продолжают жалуются на отсутствие горячей воды', TIMESTAMPADD(DAY, -7, CURRENT_TIMESTAMP));
INSERT INTO `shift_comment` (employee_id, c_message, c_date) VALUES (1, 'Постояльцы продолжают жалуются на отсутствие горячей воды', TIMESTAMPADD(DAY, -5, CURRENT_TIMESTAMP));
INSERT INTO `shift_comment` (employee_id, c_message, c_date) VALUES (1, 'Постояльцы продолжают жалуются на отсутствие горячей воды', TIMESTAMPADD(DAY, -4, CURRENT_TIMESTAMP));
...
INSERT INTO `task` (e_id_assignee, e_id_delegator, t_message, t_status, priority, t_frequency, updated, expired) VALUES (4, 2, 'call taxi', @CLOSED, 3, 'ONCE', CURRENT_TIMESTAMP, TIMESTAMPADD(DAY, -3, CURRENT_TIMESTAMP));
INSERT INTO `task` (e_id_assignee, e_id_delegator, t_message, t_status, priority, t_frequency, updated, expired) VALUES (4, 2, 'call taxi', @CLOSED, 3, 'ONCE', CURRENT_TIMESTAMP, TIMESTAMPADD(DAY, -2, CURRENT_TIMESTAMP));
