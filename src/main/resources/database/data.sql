...
INSERT INTO `task_img` (id, task_id, url) VALUES (2, 3, 'http://storage.agravery.com/uploads/files/flowers/ukraine/bouquet-3158350.jpg');
INSERT INTO `task_img` (id, task_id, url) VALUES (3, 4, 'https://cdn6.sellbe.com/p66/s-66281/product/26/205816.jpg');
INSERT INTO `task_img` (id, task_id, url) VALUES (4, 5, 'https://camellia.ua/upload/kamelia_flora/cat/82/1b/635x635/fc269977_56b4b3f1a7b06.jpg');
INSERT INTO `task_img` (id, task_id, url) VALUES (5, 6, 'http://roza.if.ua/wp-content/uploads/2017/05/961.jpg');
